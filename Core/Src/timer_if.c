...
//	HAL_GPIO_WritePin(GPIOA, RST_DBG_Pin, GPIO_PIN_SET);
//	//	HAL_RTC_DeactivateAlarm(&hrtc, RTC_ALARM_A);
//	UTIL_SEQ_SetTask((1 <<CFG_SEQ_Task_Enter_Stop2_Mode_WFI ), CFG_SEQ_Prio_0);   // set task enter to stop mode and wait for interrupt
