/**
  ...
  ******************************************************************************
  */
#ifndef AI_NETWORK_APPLTEMP_0506_H
#define AI_NETWORK_APPLTEMP_0506_H

#include "network_appltemp_0506_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_NETWORK_APPLTEMP_0506_MODEL_NAME          "network_appltemp_0506"
#define AI_NETWORK_APPLTEMP_0506_ORIGIN_MODEL_NAME   "nn_batch_irrig_our_dataset_0506"

/******************************************************************************/
#define AI_NETWORK_APPLTEMP_0506_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_APPLTEMP_0506_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_APPLTEMP_0506_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_APPLTEMP_0506_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_APPLTEMP_0506_IN \
  ai_network_appltemp_0506_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_APPLTEMP_0506_IN_SIZE { \
  AI_NETWORK_APPLTEMP_0506_IN_1_SIZE, \
}
#define AI_NETWORK_APPLTEMP_0506_IN_SIZE_BYTES { \
  AI_NETWORK_APPLTEMP_0506_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_APPLTEMP_0506_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_APPLTEMP_0506_IN_1_CHANNEL     (3)
#define AI_NETWORK_APPLTEMP_0506_IN_1_SIZE        (3)
#define AI_NETWORK_APPLTEMP_0506_IN_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_NETWORK_APPLTEMP_0506_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_APPLTEMP_0506_OUT \
  ai_network_appltemp_0506_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_APPLTEMP_0506_OUT_SIZE { \
  AI_NETWORK_APPLTEMP_0506_OUT_1_SIZE, \
}
#define AI_NETWORK_APPLTEMP_0506_OUT_SIZE_BYTES { \
  AI_NETWORK_APPLTEMP_0506_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_APPLTEMP_0506_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_APPLTEMP_0506_OUT_1_CHANNEL     (1)
#define AI_NETWORK_APPLTEMP_0506_OUT_1_SIZE        (1)
#define AI_NETWORK_APPLTEMP_0506_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_NETWORK_APPLTEMP_0506_N_NODES (4)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup network_appltemp_0506
 ...
 * @ref ai_network_appltemp_0506_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_appltemp_0506_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_appltemp_0506_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_appltemp_0506_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_APPLTEMP_0506_*
 * defines into file @ref network_appltemp_0506.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_appltemp_0506_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_APPLTEMP_0506_H */
